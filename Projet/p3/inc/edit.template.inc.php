<div id="canvasCont" onload="loadCanvas()">
    <div class="Toolbar">
        <p>- Toolbar -</p></br>
      ...
      <span><label>Thickness :</label>
        <input type="range" value="3" min="1" max="10" step="1" onchange="changeThickness(this.value, this)"><div id="thicknessShower"></div></span>
    </div>
